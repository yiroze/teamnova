<?php
include $_SERVER['DOCUMENT_ROOT']."/firstapp/api/select_pos_ad.php";
session_start();
...
<html lang="ko">
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
            <div class="page_name">원딜 게시판</div>
            </div>
            <div class="row">
                <div>
                    <div style="float:left;">
                        <form action="position_board_ad.php" method="get" id="category">
                    ...
                    if(isset($_SESSION['user_id'])){
                        ...
                        <button
                            ...
                            onclick="location.href='/firstapp/create_board/create_position.php?position=ad'">
                            글쓰기
                        </button>
                    <?php
                    }
