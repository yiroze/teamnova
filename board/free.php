<?php
session_start();
include $_SERVER['DOCUMENT_ROOT']."/firstapp/api/select_free.php";
...
<html lang="ko">
    ...
    <body>
        ...
        <div class="container">
                ...
                <div>
                    ...
                    if(isset($_SESSION['user_id'])){
                        ...
                        <button
                            ...
                            onclick="location.href='/firstapp/create_board/create_free.php'">
                            글쓰기
                        </button>
                    <?php
                    }
                    ...
                    <!-- <div style="float:right;">
                        <button
                            type="button"
                            style="width:100px; height:40px;"
                            onclick="location.href='/firstapp/api/test_api.php'">
                            글쓰기
                        </button>
                    </div> -->
                </div>
            ...
            <div class="text-center" id="pagenation">
        ...
        <script>
            document.form.category.value = '<?=$_GET[' category ']?>';
        </script>
